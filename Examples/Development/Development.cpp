...
void LoadEntities(Scene& scene, MaterialSystem& materialSystem,
                  ModelSystem& modelSystem)
{
	...
	scene.AddComponent<StaticMeshRendererComponent>(
	    testModel,
	...
	scene.AddComponent<TransformComponent>(camera, glm::vec3(6.0, 7.0, 2.5),
	                                       glm::vec3(1.0),
	                                       glm::vec3(0.0f, 0.0, 0.0));
	scene.AddComponent<CameraComponent>(camera, 45.0f, 5.0, 1.0, 0.001f, 100.0f,
...
void CreateRenderGraph(Renderer& renderer, TextureSystem& textureSystem,
                       Device* device)
{
	...
	RenderPass::CreateInfo forwardPassCreateInfo {
		...
		.colorAttachmentInfos = {
		    RenderPass::CreateInfo::AttachmentInfo {
		        ...
		        .size = { 1.0, 1.0 },
		        .sizeType =
		            RenderPass::CreateInfo::SizeType::eSwapchainRelative,
		        .format  = colorFormat,
		        .samples = sampleCount,
		        .clearValue =
		            vk::ClearValue {
