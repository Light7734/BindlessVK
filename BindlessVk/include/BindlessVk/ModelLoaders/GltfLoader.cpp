...
Model GltfLoader::load_from_ascii(const char* debug_name, const char* file_path)
{
	auto gltf_model = parse_ascii_file(file_path);
	auto model = Model { debug_name };
...
tinygltf::Model GltfLoader::parse_ascii_file(const char* file_path)
{
...
void GltfLoader::load_textures(const tinygltf::Model& gltf_model, Model& model)
{
...
void GltfLoader::load_material_parameters(const tinygltf::Model& gltf_model, Model& model)
{
...
GltfLoader::MeshData GltfLoader::load_mesh(const tinygltf::Model& gltf_model, Model& model)
{
	MeshData mesh_data;
...
Model::Node* GltfLoader::load_node(
...
void GltfLoader::load_mesh_primitives(
    const tinygltf::Model& gltf_model,
...
void GltfLoader::load_mesh_primitive_vertices(
    const tinygltf::Model& gltf_model,
...
u32 GltfLoader::load_mesh_primitive_indices(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive,
    MeshData& out_mesh_data
)
...
const float* GltfLoader::get_mesh_primitive_position_buffer(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
const float* GltfLoader::get_mesh_primitive_normal_buffer(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
const float* GltfLoader::get_mesh_primitive_tangent_buffer(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
const float* GltfLoader::get_mesh_primitive_uv_buffer(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
size_t GltfLoader::get_mesh_primitive_vertex_count(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
u32 GltfLoader::get_mesh_primitive_index_count(
    const tinygltf::Model& gltf_model,
    const tinygltf::Primitive& gltf_primitive
)
{
...
void GltfLoader::copy_mesh_data_to_gpu(Model& model, MeshData& mesh_data)
{
